...
User.create!([{
  ...
  profile_image: File.new("images/avatar1.jpg"),
  ...
  password: "password",
  password_confirmation: "password",
  profile_image: File.new("images/avatar6.jpg")
  bio: "Wine explorer"
},{
  ...
  password: "password",
  password_confirmation: "password",
  profile_image: File.new("images/avatar4.jpg")
  bio: "Just love wines!"
},{
  username: "willcook",
  ...
  password: "password",
  password_confirmation: "password",
  profile_image: File.new("images/avatar3.jpg")
  ...
  password: "password",
  password_confirmation: "password",
  profile_image: File.new("images/avatar_default.jpg")
  ...
  password: "password",
  password_confirmation: "password"
  profile_image: File.new("images/avatar5.jpg")
